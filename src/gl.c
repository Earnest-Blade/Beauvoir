...
int bvr_load_gles(GLADloadproc load){
#if BVR_USE_GLES
    int i, major, minor;
...
int bvr_load_glcore(GLADloadproc load){
#if BVR_USE_GLDESK
    int i, major, minor;
...
int bvr_load_gl(GLADloadproc load){
#if BVR_USE_GLES
    return bvr_load_gles(load);
#else
    return bvr_load_glcore(load);
#endif
}